...
public class GroceryManager {
  ...
  public GroceryManager(FoodStorage foodStorage) {
  ...
  public void addGrocery(Grocery providedGrocery) {
    ...
    Map<String, List<Grocery>> groceries = foodStorage.getGroceries();
  ...
  public List<Grocery> searchGrocery(String name) {
    ...
    for (List<Grocery> groceryList : foodStorage.getGroceries().values()) {
  ...
  public float valueOfAllGroceries() {
    try {
      return foodStorage.getGroceries().values().stream()
  ...
  public List<Grocery> getSortedList() {
    List<Grocery> allGroceries = foodStorage.getGroceries().values().stream()
        .flatMap(List::stream)
        .toList();
